...
export default function OwnersPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <p className="mb-4">차를 소유하고 계신가요? LunaVan과 함께 차량을 캠핑카로 개조·임대하여 추가 수익을 만드세요.</p>

      <h2 className="text-xl font-semibold mb-2">참여 방법</h2>
      <ol className="list-decimal list-inside mb-4">
        <li>문의: 아래 연락처로 먼저 연락주세요.</li>
        <li>상담: 차량 상태 및 개조 가능성 상담 진행</li>
        <li>계약: 수익 배분 및 대여 조건 협의</li>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>플랫폼을 통한 임대 노출 및 운영 대행 옵션</li>
        <li>정기적인 차량 관리 및 청소 서비스(선택)</li>
      </ul>
      ...
      <p className="mt-6 text-sm text-gray-600">더 자세한 조건은 상담 후 개별 협의됩니다.</p>
    </div>
  );
}